class DefaultClass:
    ...
    def addSplat(self):
        ...
        self.parent.powerSubtitle = self.widgetLib.makeLabel("Power")
        ...
        self.parent.finesseSubtitle = self.widgetLib.makeLabel("Finesse")
        ...
        self.parent.resistanceSubtitle = self.widgetLib.makeLabel("Resistance")
        ...
        self.parent.skillsTitle = self.widgetLib.makeLabel("Skills")
        self.parent.skillsTitle.setFont(self.parent.titlefont)

        self.parent.mentalSubtitle = self.widgetLib.makeLabel("Mental")
        self.parent.mentalSubtitle.setFont(self.parent.subtitlefont)
        self.parent.mentalPenalty = self.widgetLib.makeLabel("-3 unskilled")
        ...
        self.parent.physicalSubtitle = self.widgetLib.makeLabel("Physical")
        self.parent.physicalSubtitle.setFont(self.parent.subtitlefont)
        self.parent.physicalPenalty = self.widgetLib.makeLabel("-1 unskilled")
        ...
        self.parent.socialSubtitle = self.widgetLib.makeLabel("Social")
        self.parent.socialSubtitle.setFont(self.parent.subtitlefont)
        self.parent.socialPenalty = self.widgetLib.makeLabel("-1 unskilled")
